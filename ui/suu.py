...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Rects Boxing"))
        self.toolButton.setText(_translate("MainWindow", "数据文件输入"))
        ...
        self.label_2.setText(_translate("MainWindow", "占地面积"))
